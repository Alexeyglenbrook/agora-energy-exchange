...
Стан «Повернено заявнику» у поточній документації процесу не має визначеного зворотного переходу до «Подано» — на практиці очікується повторне подання заявником після усунення зауважень, але цей крок не описаний окремою user story і потребує окремого рішення поза межами поточної специфікації.
