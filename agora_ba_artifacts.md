...
Наскрізні бізнес-правила процесу акредитації, зведені окремо від user stories, щоб їх можна було перевіряти і трасувати незалежно від конкретного сценарію. ID використовуються для трасування з UAT-чеклістом (розділ 6) та прототипом.
