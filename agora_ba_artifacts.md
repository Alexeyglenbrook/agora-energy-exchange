...
[🔍 Відкрити AS-IS у повному розмірі](agora_bpmn_as_is.svg) — вбудоване зображення GitHub стискає під ширину сторінки; за посиланням векторна діаграма відкривається в повному масштабі й читається чітко на будь-якому зумі.
...
[🔍 Відкрити TO-BE у повному розмірі](agora_bpmn_to_be.svg)
