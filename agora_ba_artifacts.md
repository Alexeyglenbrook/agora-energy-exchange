...
* **Scope:**
  * **In-Scope:** Модуль акредитації учасників, перевірка лімітів, прийом та валідація заявок, біржовий движок (Matching Engine), інтеграція з клірингом та TSO/DSO, статусні моделі.
  * **Out-of-Scope:** P2P-торгівля для фізичних осіб, роздрібний білінг.
## Зміст
...
- [6. Процес акредитації AS-IS,TO-BE та GAP-аналіз](#6-процес-акредитації-as-is-to-be-та-gap-аналіз)
...
## 6. Процес акредитації AS-IS,TO-BE та GAP-аналіз
