...
stateDiagram-v2
    ...
    note right of Submitted
        Позначка «Перевірка триває довше
        очікуваного» при недоступності
        сервісу перевірки (US-02, сц. 4)
    end note
    note right of CommitteeReview
        Позначка «Прострочено» після
        10 робочих днів без рішення (US-04, сц. 3)
    end note
    note right of AwaitingTraining
        Завдання на ручну активацію при
        відмові сервісу активації (US-06, сц. 3)
    end note
```
