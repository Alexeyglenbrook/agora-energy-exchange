...
* **Problem Statement:** Текущие процессы торговли энергоносителями требуют автоматизации матчинга заявок, проверки финансовых лимитов и интеграции с TSO/DSO для снижения операционных рисков.
* **Project Goal:** Создание высоконагруженной платформы (Agora Energy Exchange) для автоматизации биржевых торгов и клиринга.
* **Scope:** 
  * **In-Scope:** Модуль приема и валидации заявок, биржевой движок (Matching Engine), интеграция с клирингом и TSO/DSO, статусные модели.
  * **Out-of-Scope:** P2P-торговля для физических лиц, розничный биллинг.
## Зміст
