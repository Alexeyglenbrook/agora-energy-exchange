...
|---|---|---|
| Чернетка → Подано | Заявник | Заповнено всі обов'язкові поля анкети |
| Подано → На перевірці документів | Співроб. акредитації | Автоматично після реєстрації заявки |
| На перевірці документів → Повернено заявнику | Співроб. акредитації | Пакет документів неповний або з помилками |
| На перевірці документів → На розгляді комітету | Юридичний відділ, Фінмоніторинг | Пакет повний; юридична та AML-перевірка виконуються паралельно, обидва висновки позитивні |
